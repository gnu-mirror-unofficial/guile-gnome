...
;;; Commentary:
;;
;;g-wrap specification for libvte.
;;
;;; Code:

(define-module (gnome gtk gw-vte-spec)
  :use-module (g-wrap)
  :use-module (gnome gobject gw-gobject-spec)
  :use-module (gnome gtk gw-gtk-spec)
  :use-module (gnome gobject defs-support))

(let ((ws (gw:new-wrapset "guile-gnome-gw-vte")))

  (gw:wrapset-set-guile-module! ws '(gnome gnome gw-vte))
  ...
  (register-type "guile-gnome-gw-vte" "pid_t" '<gw:unsigned-long>) ; FIXME!

  (load-defs ws "gnome/defs/vte.defs"))
